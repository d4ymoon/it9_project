...
class Payroll1 extends Model
{
    //
    protected $fillable = ['employee_id','pay_period','days_worked','basic_pay','overtime_pay','total_deductions','taxable_income','tax','net_salary',
    ];
