...
<html lang="en" data-bs-theme="auto">
  <head><script src="{{ asset('js/color-modes.js') }}"></script></script>
...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Payroll System</a>
      ...
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a href="{{ route('positions.index') }}" class="nav-link d-flex align-items-center gap-2"  target="content-frame" onclick="saveIframePage('{{ route('positions.index') }}')">
                  <i class="bi bi-people"></i> <span class="sidebar-text">Positions</span>
              </a>
          </li>
          <li>
            <a href="{{ route('employees.index') }}" class="nav-link d-flex align-items-center gap-2" target="content-frame" onclick="saveIframePage('{{ route('employees.index') }}')">
                <i class="bi bi-people"></i> <span class="sidebar-text">Employees</span>
            </a>
        </li>
        <li>
            <a href="{{ route('payrolls.index') }}" class="nav-link d-flex align-items-center gap-2" target="content-frame" onclick="saveIframePage('{{ route('payrolls.index') }}')">
