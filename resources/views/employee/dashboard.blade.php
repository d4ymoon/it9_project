...
<body style="overflow:hidden">
            ...
            <div id="sidebar" class="col-auto col-md-3 col-xl-2 px-0 sidebar-expanded" style="background-color: #222222; overflow:hidden; width: 200px;">
                <div class="d-flex flex-column align-items-center px-3 pt-2 text-white min-vh-90">                          
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center" id="menu">
                        ...
                        <li>
                            <a href="{{ route('employee.dashboard') }}" class="nav-link align-middle px-2" target="content-frame" onclick="saveIframePage('{{ route('employee.dashboard') }}')">
                        ...
                        <li>
                            <a href="{{ route('attendances.create') }}" class="nav-link px-2 align-middle" target="content-frame" onclick="saveIframePage('{{ route('attendances.create') }}')">
                                <i class="bi bi-person-check"></i> <span class="sidebar-text">Record Attendance</span>
                            </a>
                        </li>

                        <li>
                            <a href="{{ route('employee.attendances') }}" class="nav-link px-2 align-middle" target="content-frame" onclick="saveIframePage('{{ route('employee.attendances') }}')">
                                <i class="bi bi-journal"></i> <span class="sidebar-text">My Attendance</span>
                            </a>
                        </li>

                        <li>
                            <a href="{{ route('employee.payslips') }}" class="nav-link px-2 align-middle" target="content-frame" onclick="saveIframePage('{{ route('employee.payslips') }}')">
                                <i class="bi bi-receipt"></i> <span class="sidebar-text">My Payslips</span>
                            </a>
                        </li>

                        <li>
                            <a href="{{ route('employee.loans') }}" class="nav-link px-2 align-middle" target="content-frame" onclick="saveIframePage('{{ route('employee.loans') }}')">
                                <i class="bi bi-cash-coin"></i> <span class="sidebar-text">My Loans</span>
                            </a>
                        </li>
                    </ul>
                    <hr>
    ...
    window.onload = function () {
        var lastPage = localStorage.getItem('lastIframePage') || '{{ route('employee.dashboard') }}';
